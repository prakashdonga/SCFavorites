...
-(void) setImage:(UIImage*)theImage {
    ...
    if (cropSize.width != 0 && cropSize.height != 0 && needCroping) 
    {
        ...
        theImage = [theImage crop:CGRectMake(0.0, 0.0, cropSize.width, cropSize.height)];
...
-(void) needCropingToSize:(CGSize) size 
{
    needCroping = YES;
    cropSize = size;
}
